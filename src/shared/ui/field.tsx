...
export function fieldClassName(className?: string) {
  return cn(
    "w-full rounded-[18px] border border-[var(--plotty-line)] bg-white/84 px-4 text-[15px] text-[var(--plotty-ink)] outline-none transition-colors placeholder:text-[var(--plotty-muted)] focus:border-[var(--plotty-accent)] focus-visible:ring-2 focus-visible:ring-[var(--plotty-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--plotty-paper)]",
    className,
  );
}
