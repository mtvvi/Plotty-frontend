...
const defaultRoutes = [
  ...
  { name: "profile", path: "/users/ilya" },
  { name: "collection", path: "/users/ilya/collections/1" },
  { name: "story", path: "/stories/minecraft" },
  { name: "reader", path: "/stories/minecraft/chapters/1" },
